...
# va a servir para saber si hacemos clic en la bola
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP:    # hemos hecho clic en la bola¿¿¿???
            ...
            # y luego hacer cálculos para ver si hemos hecho clic en la imagen...
            ...
            # o sea, dado un rectángulo, nos dice si la posición indicada está dentro o fuera....
            # <someRectangle>.collide_point(<someXYLocation>)
