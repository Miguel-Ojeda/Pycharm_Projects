...
aBall = Ball(window)
simple_text_fc_label = SimpleText(window, (60, 20), 'Program has run through this many loops: ', WHITE)
simple_text_fc_value = SimpleText(window, (500, 20), '', WHITE)
restart_button = SimpleButton(window, (280, 60), 'images/restartUp.png', 'images/restartDown.png')
frame_counter = 0
