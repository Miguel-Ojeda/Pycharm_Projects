...
# Creamos una lista con todas las bolas del juego...!! es muy sencillo
ball_list = []
for i in range(0, N_BALLS):
    aBall = Ball(window)
    ball_list.append(aBall)
