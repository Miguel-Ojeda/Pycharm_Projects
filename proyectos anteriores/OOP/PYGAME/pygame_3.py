...
pygame.mixer.music.load('sounds/background.mp3')  # o sea, sólo hay una música!!
pygame.mixer.music.play(-1, 0.0)   # reproducimos el fichero de música cargado previamente... (-1 para indefinido)
