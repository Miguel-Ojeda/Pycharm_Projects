...
PEOPLE: List[str] = ["Michael", "Sarah", "Joshua", "Narine", "David", "Sajid",
                     ...
                     'Juanito', 'Pepito', 'Miguelito', 'Kockinsky', 'Margaret', 'Elisabeth',
                     'Jaimito', 'Perkings', 'Carlos', 'Aray', 'Iris', 'Ángel', 'Mariate',
                     'Joel', 'Ana', 'Sergio', 'Carolina', 'Víctor', 'Yurena', 'Vanessa']
...
if __name__ == "__main__":
    print(f'tamaño inicial de la compresión: {getsizeof(compress(dumps(PEOPLE)))}')
